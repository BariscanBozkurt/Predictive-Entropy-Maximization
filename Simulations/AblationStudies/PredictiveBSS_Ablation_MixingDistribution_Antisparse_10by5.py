...
print("Running script PredictiveBSS_Ablation_MixingDistribution_Antisparse_10by5")

results_dir = "../Results"
os.makedirs(results_dir, exist_ok=True)

csv_name_for_results = "predictive_bss_ablation_mixing_distribution_antisparse_10by5_results.csv"
...
for dist_idx, mixing_distribution in enumerate(mixing_distribution_list):
    for seed in seed_list:
        ...
        S = 2 * S - 1  # antisparse domain in [-1,1]
